...
<body>
    ...
    <main>
        ...
        <a href="SupplierManageHome.php" style="text-decoration: none;">
            <section class="main-block">
                <h2>Supplier Management System</h2>
                <img src="supplier.png" class="block_img">
            </section>
        </a>
        <a href="indexx.php" style="text-decoration: none;">
            <section class="main-block">
        ...
        <a href="dashboard.php" style="text-decoration: none;">
            <section class="main-block">
                ...
                <img src="emp.png" class="block_img">
            </section>
        </a>

        ...
        <div class="row">
            <div class="col-md-12">
                <div class="tile">
                    ...
                    <div class="tile-body">
                        <?php
                        $sql = "SELECT salary, allowancesalary, total, tbladdsalary.create_date, tbldepartment.DepartmentName, tblemployee.EmpID, fname, lname, email, mobile, country, state, city, address, photo, dob, date_of_joining FROM tbladdsalary
                        ...
                        <table class="table table-hover table-bordered">
                            <tbody>
                                <tr>
                                    <th colspan="4" style="font-size:20px; color:blue;">Personal Info</th>
                                </tr>
                                <tr>
                                    <th>EmpId</th>
